...
function pieChartgenero() {
    ...
    var ctx = document.getElementById("pieChartgenero").getContext("2d");
    var pieChart = new Chart(ctx).Pie(datagenero);

    legend(document.getElementById("pieLegend"), datagenero, pieChart);
}
